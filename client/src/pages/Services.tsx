    ...
    <div className="min-h-screen bg-[#0F172A] text-[#E2E8F0] overflow-hidden relative">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <button 
                    onClick={() => window.location.href = 'https://wa.me/5511978768690'}
                    className="w-full glass-card px-6 py-3 font-semibold hover:border-cyan-400/50 transition-all flex items-center justify-center gap-2"
                  >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <button 
            onClick={() => window.location.href = 'https://wa.me/5511978768690'}
            className="btn-gradient text-lg py-6 inline-flex items-center gap-2"
          >
