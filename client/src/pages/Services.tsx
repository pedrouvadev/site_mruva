...
export default function Services() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title =
      "Serviços Profissionais de Tecnologia e Marketing | Pedro Uva";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute(
        "content",
        "Conheça os serviços de Desenvolvimento Full-Stack, IA e Marketing Digital do Pedro Uva. Soluções de elite para transformar seu negócio."
      );
    }
  }, []);

  const whatsappLink =
    "https://wa.me/5511978768690?text=Olá%20Pedro!%20Vi%20seus%20serviços%20e%20quero%20elevar%20o%20nível%20do%20meu%20projeto.";
  ...
  const services = [
    {
      ...
      description:
        "Eu desenvolvo sistemas robustos, rápidos e seguros. Do banco de dados à interface, utilizo o que há de mais moderno (React 19, Node.js, TypeScript) para entregar uma experiência impecável ao seu usuário final.",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Análise de Dados e Funis de Conversão",
    ...
    },
    {
      ...
      headline:
        "Coloco a Inteligência Artificial para trabalhar pelo seu lucro.",
      description:
        "Integro LLMs (como GPT-4) e automações de fluxo para eliminar tarefas repetitivas e aumentar a produtividade da sua equipe em até 10x. Tecnologia de ponta aplicada ao seu operacional.",
      features: [
    ...
    },
    {
      ...
      description:
        "Eu faço um diagnóstico profundo da sua operação e desenho o roadmap tecnológico. Unimos código, marketing e gestão ágil para garantir que sua empresa lidere o mercado, não apenas sobreviva.",
      features: [
        "Diagnóstico Tecnológico Completo",
        "Planejamento Estratégico Digital",
        "Implementação de Cultura Ágil (Scrum)",
        "Mentoria em Tecnologia e Inovação",
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="title-standard animate-fade-in animation-delay-100 tracking-tighter">
            Estratégia e tecnologia para{" "}
            <span className="bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">
              escalar vendas com previsibilidade e ROI
            </span>
          </h1>

          <p className="mb-12 max-w-4xl mx-auto animate-fade-in animation-delay-200 font-medium">
            Mais que serviços, projeto a evolução do seu negócio. Com mais de 25
            anos no campo de batalha da tecnologia e dos negócios, uno{" "}
            <strong className="text-white">Código de Elite</strong>,{" "}
            <strong className="text-white">Marketing de Dados</strong> e{" "}
            <strong className="text-white">Inteligência Artificial</strong> para
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-20 animate-fade-in">
            <h2 className="title-standard text-center text-4xl md:text-5xl font-bold">
              Como posso{" "}
              <span className="text-cyan-400">alavancar seu negócio?</span>
            </h2>
            <p className="text-xl text-[#94A3B8] max-w-3xl mx-auto font-medium">
              Cada projeto que assumo é tratado com rigor técnico e visão de
              dono. Escolha o pilar que sua empresa precisa fortalecer hoje:
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              <h2 className="title-standard text-4xl md:text-5xl font-bold">
                Por que confiar o seu projeto{" "}
                <span className="text-indigo-400">nas minhas mãos?</span>
              </h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#94A3B8] text-lg">
                      Trabalho com metodologias ágeis (Scrum/Kanban). Você sabe
                      exatamente o que está sendo feito, em tempo real, sem
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-2xl font-bold text-white mb-2">
                      Visão 360º de Negócio
                    </h4>
                    <p className="text-[#94A3B8] text-lg">
                      Eu não sou apenas um programador. Sou um estrategista. Meu
                      objetivo é fazer sua empresa lucrar mais através da
                      tecnologia.
                    </p>
                  </div>
                </div>
      ...
      <section className="section-standard relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center glass-card p-12 md:p-20 border border-cyan-500/20 shadow-[0_0_100px_rgba(34,211,238,0.1)]">
          ...
          <p className="mb-12 max-w-2xl mx-auto text-lg font-medium text-[#E2E8F0]">
            Estou pronto para aplicar minha experiência e as melhores
            tecnologias do mercado no seu próximo grande desafio.
          </p>
      ...
      <script type="application/ld+json">
        {`{
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "Quais tecnologias Uva utiliza no desenvolvimento?",
              "acceptedAnswer": {
                "@type": "Answer",
