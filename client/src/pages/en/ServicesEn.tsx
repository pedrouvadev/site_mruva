  ...
  const services = [
    {
      ...
      description: "I develop robust, fast, and secure systems. From database to interface, I use the latest technologies (React 19, Node.js, TypeScript) to deliver a flawless experience to your end user.",
      features: ["High-Performance Web Applications", "Scalable and Secure Systems", "Modern Interfaces (UI/UX)", "API and Database Integration", "Clean and Maintainable Architecture"],
    ...
    },
    {
      ...
      headline: "I transform clicks into real revenue with data-driven strategy.",
      description: "I don't believe in \"vanity metrics.\" My approach focuses on ROI. I use Google Ads, Meta Ads, and advanced SEO to put your brand in front of those who actually want to buy from you.",
      features: ["Paid Traffic Management (Google/Meta)", "Technical SEO for Real Ranking", "Data Analysis and Conversion Funnels", "Growth Hacking Strategies", "Conversion Rate Optimization (CRO)"],
    ...
    },
    {
      ...
      description: "I integrate LLMs (like GPT-4) and workflow automations to eliminate repetitive tasks and increase your team's productivity by up to 10x. Cutting-edge technology applied to your operations.",
      features: ["Integration of LLMs and AI Agents", "Workflow Automation", "Intelligent Support Chatbots", "Specialized Prompt Engineering", "Predictive Data Analysis"],
    ...
    },
    {
      ...
      description: "I perform a deep diagnosis of your operation and design the technological roadmap. We combine code, marketing, and agile management to ensure your company leads the market, doesn't just survive.",
      features: ["Complete Technological Diagnosis", "Digital Strategic Planning", "Agile Culture Implementation (Scrum)", "Technology and Innovation Mentoring", "Continuous Support and Evolution"],
      ...
      <div className="relative z-10">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="title-standard animate-fade-in animation-delay-100 tracking-tighter">
            Strategy and technology to <span className="bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">scale sales with predictability and ROI</span>
          </h1>

          <p className="mb-12 max-w-4xl mx-auto animate-fade-in animation-delay-200 font-medium">
            More than services, I design your business's evolution. With over 25 years on the technology and business battlefield, I unite <strong className="text-white">Elite Code</strong>, <strong className="text-white">Data Marketing</strong>, and <strong className="text-white">Artificial Intelligence</strong> to scale your operation.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16 animate-fade-in animation-delay-300">
            ...
            >
              Request Strategic Diagnosis <ArrowRight className="ml-2 w-6 h-6" />
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="section-standard bg-[#0B1120]">
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-20 animate-fade-in">
              <h2 className="title-standard text-center text-4xl md:text-5xl font-bold">How can I <span className="text-cyan-400">leverage your business?</span></h2>
              <p className="text-xl text-[#94A3B8] max-w-3xl mx-auto font-medium">
                Every project I take on is treated with technical rigor and an owner's mindset. Choose the pillar your company needs to strengthen today:
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in">
                <h2 className="title-standard text-4xl md:text-5xl font-bold">Why trust your project <span className="text-indigo-400">in my hands?</span></h2>
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-white mb-2">Security and Transparency</h4>
                      <p className="text-[#94A3B8] text-lg">I work with agile methodologies (Scrum/Kanban). You know exactly what is being done, in real time, with no budget surprises.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-white mb-2">360º Business Vision</h4>
                      <p className="text-[#94A3B8] text-lg">I am not just a programmer. I am a strategist. My goal is to make your company more profitable through technology.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="section-standard relative">
          ...
          <div className="max-w-4xl mx-auto relative z-10 text-center glass-card p-12 md:p-20 border border-cyan-500/20 shadow-[0_0_100px_rgba(34,211,238,0.1)]">
            <h2 className="title-standard text-center text-4xl md:text-6xl font-bold tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">to life now?</span>
            </h2>
            <p className="mb-12 max-w-2xl mx-auto text-lg font-medium text-[#E2E8F0]">
              I am ready to apply my experience and the best technologies on the market to your next big challenge.
            </p>
