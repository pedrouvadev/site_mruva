import { ArrowRight, Code, Bot, TrendingUp, Layers, MessageCircle, Shield, Rocket, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#E2E8F0] overflow-hidden relative font-sans">
      ...
      <div className="relative z-10">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-6 animate-fade-in flex justify-center inline-block max-w-full">
              <div className="glass-card px-4 py-2 text-sm font-semibold text-cyan-400 inline-flex items-center gap-2 border border-cyan-500/30">
                <Rocket className="w-4 h-4" /> Global Tech & Marketing Partner
              </div>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight animate-fade-in animation-delay-100 tracking-tight">
              Engineering Digital Growth Through <span className="bg-gradient-to-r from-cyan-400 to-indigo-500 bg-clip-text text-transparent">AI, Code, & Marketing</span>
            </h1>

            <p className="text-xl md:text-2xl text-[#94A3B8] mb-10 max-w-3xl mx-auto animate-fade-in animation-delay-200 leading-relaxed">
              Bringing Brazilian tech excellence to the global market. Full-stack solutions, driven by data, scaled by Artificial Intelligence. 
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in animation-delay-300">
              ...
              >
                Book a Global Call <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 relative bg-[#0B1120]">
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">The <span className="text-cyan-400">Arsenal</span></h2>
              <p className="text-xl text-[#94A3B8] max-w-2xl mx-auto">
                Elite capabilities systematically combined to build, launch, and scale world-class digital products.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Modern web apps, scalable architecture, and flawless integrations using React, Node, and cutting-edge stacks."
                },
                {
                  icon: <Bot className="w-8 h-8 text-indigo-400" />,
                  title: "Artificial Intelligence",
                  desc: "Smart automations, custom AI integrations, and LLM workflows that multiply your team's output."
                },
                {
                  icon: <TrendingUp className="w-8 h-8 text-blue-400" />,
                  title: "Digital Marketing",
                  desc: "High-ROI campaigns, Conversion Rate Optimization (CRO), and data-driven growth strategies."
                },
                {
                  icon: <Layers className="w-8 h-8 text-purple-400" />,
                  title: "Project Management",
                  desc: "Agile methodologies, clear scopes, and seamless leadership of remote global teams."
                }
              ].map((service, idx) => (
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in">
                <h2 className="text-4xl md:text-5xl font-bold mb-6">The "Mr. Uva" <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Method</span></h2>
                <p className="text-xl text-[#94A3B8] mb-8 leading-relaxed">
                  Most professionals are either deeply technical but lack business sense, or strategic but can't execute. I bridge the gap.
                </p>
                
                <ul className="space-y-6">
                  {[
                    "Uniting Development, Marketing, and Project Management into one cohesive force.",
                    "Strategic foresight combined with pixel-perfect, bug-free execution.",
                    "Obsessed with ROI, performance metrics, and user experience."
                  ].map((item, i) => (
              ...
              <div className="glass-card p-2 animate-fade-in animation-delay-200 border border-white/10 relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-2xl blur opacity-20" />
                <div className="relative bg-[#0F172A] rounded-xl p-8 h-full flex flex-col justify-center">
                  <h3 className="text-2xl font-bold mb-4">A Multidisciplinary Profile</h3>
                  <p className="text-[#94A3B8] text-lg mb-6">
                    Hire an entire squad's worth of skills in one highly-focused professional. No communication breakdowns between dev and marketing. Just rapid, scalable results.
                  </p>
                  <Button 
                    variant="outline" 
                    className="w-fit border-cyan-500/50 text-cyan-400 hover:bg-cyan-950"
                    onClick={() => window.open(whatsappLink, '_blank')}
                  >
        ...
        {/* 3. The "Global Ready" Section (Cambly Integration) */}
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-sm font-semibold mb-6">
                <Shield className="w-4 h-4" /> Global Communication Ready
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">No Language <span className="text-blue-400">Barriers</span>.</h2>
              <p className="text-xl text-[#94A3B8] max-w-2xl mx-auto">
                Seamless daily stand-ups, high-stakes negotiations, and cultural alignment. 
                Ready to integrate instantly into international, remote-first teams.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="space-y-8">
                <div className="glass-card p-6 border-l-4 border-l-blue-500">
                  <h4 className="text-2xl font-bold text-white mb-2">Verified by Cambly</h4>
                  <p className="text-[#94A3B8]">
                    Over <strong>69+ hours</strong> of intensive conversation with native speakers worldwide. A completely friction-free dynamic for global business operations.
                  </p>
                </div>
        ...
        <section className="py-32 px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-4xl mx-auto relative z-10 text-center glass-card p-12 md:p-20 border border-cyan-500/20 shadow-[0_0_100px_rgba(34,211,238,0.1)]">
            <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">world-class?</span>
            </h2>
            <p className="text-xl text-[#94A3B8] mb-12 max-w-2xl mx-auto">
              Stop settling for average execution. Let's engineer digital growth that disrupts your market and scales globally.
            </p>
