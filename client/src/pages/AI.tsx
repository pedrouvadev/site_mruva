...
export default function AI() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Serviços de IA Generativa & Automação com LLM | Pedro Uva";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Implementação estratégica de IA Generativa, Vertex AI e LLMs. Automatize seus processos e ganhe produtividade com soluções de IA customizadas.");
    }
  }, []);
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#E2E8F0] overflow-hidden relative font-sans selection:bg-cyan-500/30">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-6 flex justify-center animate-fade-in">
            <div className="glass-card px-4 py-2 text-sm font-semibold text-cyan-400 inline-flex items-center gap-2 border border-cyan-500/30 uppercase tracking-widest">
              <Brain className="w-4 h-4" /> IA & Google Cloud • 25 Certificações
            </div>
          </div>

          <h1 className="title-standard animate-fade-in animation-delay-100 tracking-tighter">
            Eu Construo <span className="bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">Inteligência</span>, Não Apenas Uso
          </h1>

          <p className="mb-12 max-w-4xl mx-auto animate-fade-in animation-delay-200 font-medium">
            50 horas de treinamento em IA Generativa, Vertex AI, Gemini e MLOps. 25 certificações oficiais do Google Cloud comprovando expertise em arquitetura de IA.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16 animate-fade-in animation-delay-300">
            ...
            >
              Explore Expertise em IA <ArrowRight className="ml-2 w-6 h-6" />
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-card p-8">
              ...
              <ul className="space-y-3 text-[#94A3B8]">
                ...
                <li>✓ Engenharia de Prompts Avançada</li>
                <li>✓ Large Language Models</li>
                <li>✓ IA Responsável</li>
                <li>✓ BigQuery ML e Analytics</li>
              </ul>
            </div>

            <div className="glass-card p-8">
              <h3 className="text-2xl font-bold mb-6 text-cyan-400">25 Certificações Oficiais</h3>
              <ul className="space-y-3 text-[#94A3B8]">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8">
              ...
              <p className="text-[#94A3B8] mb-6">
                Chatbots e IVR de alta performance com Gemini. Atendimento inteligente 24/7.
              </p>
              <ul className="space-y-2 text-sm text-[#94A3B8]">
            ...
            <div className="glass-card p-8">
              ...
              <p className="text-[#94A3B8] mb-6">
                Implementação ética de IA com governança e conformidade. IA que constrói confiança.
              </p>
              <ul className="space-y-2 text-sm text-[#94A3B8]">
                <li>✓ Governança de IA</li>
                <li>✓ Mitigação de viés</li>
      ...
      <section className="section-standard">
        <div className="max-w-4xl mx-auto">
          <h2 className="title-standard text-center text-4xl font-bold">Certificado de Conclusão</h2>
          <p className="text-center text-[#94A3B8] mb-12 max-w-2xl mx-auto text-lg">
            Certificado oficial de conclusão do curso de IA Generativa e Google Cloud
          </p>
          
          <div className="glass-card p-8 hover:scale-105 transition-transform cursor-pointer">
            <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663077556779/YTU8YzkRmKenKkuZ8w6esk/certificado-google-cloud_34e230fd.png" alt="Certificado Google Cloud de Conclusão" className="w-full h-auto rounded-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="section-standard">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6">
              <h3 className="text-lg font-bold mb-4 text-orange-400">Deploy e Ops</h3>
              <ul className="space-y-2 text-sm text-[#94A3B8]">
                <li>• Cloud Run</li>
